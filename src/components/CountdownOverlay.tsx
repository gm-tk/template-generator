...
export default function CountdownOverlay({
  ...
  return (
    ...
    >
      {/* Backdrop — fades the background, clickable to cancel */}
      <div className="absolute inset-0 bg-white/80 backdrop-blur-sm" />

      {/* Countdown content — clicks here do NOT cancel (stopPropagation) */}
      <div
      ...
      >
        ...
        <div
          key={value}
          className="text-9xl font-bold leading-none select-none text-gray-800 animate-[countdown-tick_0.4s_ease-out]"
